    ...
    def poison_dataset(self):
        ...
        if args.attack_mode.lower() in ['mr', 'dba', 'flip', 'combine']:
            ...
            if self.params['dataset'] == 'cifar10' or self.params['dataset'] == 'cifar100':
                ...
                with open('./FL_Backdoor_CV/data/southwest_images_new_train.pkl', 'rb') as train_f:
                    saved_southwest_dataset_train = pickle.load(train_f)

                with open('./FL_Backdoor_CV/data/southwest_images_new_test.pkl', 'rb') as test_f:
            ...
            if self.params['dataset'] in ['emnist', 'fmnist']:
                ...
                ardis_images = np.loadtxt('./FL_Backdoor_CV/data/ARDIS/ARDIS_train_2828.csv', dtype='float')
                ardis_labels = np.loadtxt('./FL_Backdoor_CV/data/ARDIS/ARDIS_train_labels.csv', dtype='float')

                ardis_test_images = np.loadtxt('./FL_Backdoor_CV/data/ARDIS/ARDIS_test_2828.csv', dtype='float')
                ardis_test_labels = np.loadtxt('./FL_Backdoor_CV/data/ARDIS/ARDIS_test_labels.csv', dtype='float')
