...
parser.add_argument('--params', default='utils/cifar10_params.yaml',
                    choices=['utils/cifar10_params.yaml',  'utils/fmnist_params.yaml', 'utils/emnist_byclass_params.yaml'], dest='params')


parser.add_argument('--emnist_style', default='byclass', type=str,
...
parser.add_argument('--resumed_name', default='cifar10/avg_300.pth', type=str)
...
parser.add_argument('--number_of_adversaries', default=0, type=int,
