...
class SA_ClientAgent(Agent):
    ...
    def __init__(self, id, name, type,
        ...
        # self.num_choose = math.ceil(math.log2(self.num_clients)) * 5
        self.num_choose = num_neighbors
        ...
        if msg.body['msg'] == "REQ_CHOICE":
            ...
            if msg.body['iteration'] == self.current_iteration:
                ...
                mi_shares = secret_int_to_points(secret_int=mi_number, 
                    ...
                    num_points=len(self.neighbors), prime=self.secret_sharing_prime
                )
                ...
                # 生成范围证明
                self._generate_range_proof(mi_number)
